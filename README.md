...
Interactive Molecular Dynamics (iMD) in XR, an application built with the NanoVer
framework.
...
* Create a conda environment (here we call the environment "nanover"): `conda create -n nanover "python>3.12"`
* Activate the conda environment: `conda activate nanover`
* Install the NanoVer IMD package: `conda install irl::nanover-imd-xr`
* Run the command `nanover-imd-xr`
